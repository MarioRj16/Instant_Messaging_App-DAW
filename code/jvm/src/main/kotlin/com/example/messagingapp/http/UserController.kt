...
import com.example.messagingapp.http.model.LoginModel
import com.example.messagingapp.http.model.RegistrationInvitationCreateOutputModel
import com.example.messagingapp.http.model.UserCreateInputModel
import com.example.messagingapp.http.model.UserProfileOutputModel
...
class UserController(
    ...
    fun login(
        @RequestBody user: LoginModel,
    ): ResponseEntity<TokenExternalData> =
